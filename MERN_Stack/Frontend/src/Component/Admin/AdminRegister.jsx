...
export default function AdminRegister() {
  ...
  const handleSignUp = async (e) => {
    ...
    // const response = await axios.post('http://localhost:2006/AdminRegister', { name, number, email, password, city, gender })
      ...
      <div className="main_singIn">
        ...
        <div className="signIn_left">
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <Link to="/AdminLogin" onClick={() => setSlideDirection("slide-out-right")}>
              <button>
